...
| --- | --- | --- |
| §1.1 Basic constructions | `DECOMPOSED` | [Ten fully formalized nodes](../roadmap/fundamental-group/basic-constructions/README.md) cover the selected source results |
| §1.1 results outside the selected slice | `DEFERRED` | Corollaries 1.11 and 1.16, Proposition 1.17, and Lemma 1.19 are reserved for a later §1.1 completion pass |
...
pages 25–38, decomposed into ten nodes. The main target is Theorem 1.7,
...
(retracts and deformation retracts), and Lemma 1.19 (the basepoint-change
formula for homotopic maps) are deliberately excluded from this slice.
...
fully covered even when all ten nodes are complete.
