...
contract. The selected scope contains 148 formalizable leaves, of which 145
are complete: 127 local declarations and 18 pinned Mathlib declarations. This
...
spine, and two Appendix A.1 prerequisites—plus twelve nodes in a fifteen-leaf
...
relative homotopy branch through Proposition 2.19 is also complete. Three
downstream nodes remain; the pointed comparison and reduced pair sequence are
