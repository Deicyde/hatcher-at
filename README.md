...
contract. The selected scope contains 148 formalizable leaves, of which 146
are complete: 128 local declarations and 18 pinned Mathlib declarations. This
...
spine, and two Appendix A.1 prerequisites—plus thirteen nodes in a fifteen-leaf
...
are also complete. Two downstream nodes remain: the pointed comparison and
