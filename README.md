...
contract. The selected scope contains 148 formalizable leaves, of which 142
are complete: 124 local declarations and 18 pinned Mathlib declarations. This
...
spine, and two Appendix A.1 prerequisites—plus nine nodes in a fifteen-leaf
...
singular-pair and relative-homology functors are complete, as is the pair long
exact sequence with its connecting-map formula. Six downstream nodes remain;
five are ready to state and one awaits pair-sequence naturality.
