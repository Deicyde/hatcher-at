...
contract. The selected scope contains 148 formalizable leaves, of which 139
are complete: 121 local declarations and 18 pinned Mathlib declarations. This
...
spine, and two Appendix A.1 prerequisites—plus six nodes in a fifteen-leaf
§2.1 reduced- and relative-homology slice. Its four-node reduced-homology
branch, generic exact-sequence theorem, and simplicial-pair foundation are
complete. Nine downstream nodes remain, with the singular-pair functor ready
next.
