...
contract. The selected scope contains 148 formalizable leaves, of which 141
are complete: 123 local declarations and 18 pinned Mathlib declarations. This
...
spine, and two Appendix A.1 prerequisites—plus eight nodes in a fifteen-leaf
...
singular-pair and relative-homology functors are complete. Seven downstream
nodes remain, with four statements now ready to formalize.
