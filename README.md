...
contract. The selected scope contains 148 formalizable leaves, of which 143
are complete: 125 local declarations and 18 pinned Mathlib declarations. This
...
spine, and two Appendix A.1 prerequisites—plus ten nodes in a fifteen-leaf
...
exact sequence, its connecting-map formula, and pair-sequence naturality. Five
downstream nodes remain; four are ready to state, while reduced-pair-sequence
