...
contract. The selected scope contains 148 formalizable leaves, all of which are
...
with its naturality, and the pointed comparison are also complete. This
completes the selected §2.1 slice.
