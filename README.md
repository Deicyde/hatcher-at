...
contract. The selected scope contains 148 formalizable leaves, of which 138
are complete: 123 local declarations and 15 pinned Mathlib declarations. This
...
spine, and two Appendix A.1 prerequisites—plus five nodes in a fifteen-leaf
§2.1 reduced- and relative-homology slice. Its four-node reduced-homology
branch and generic exact-sequence theorem are complete; the remaining ten
nodes are blocked by the simplicial-pair foundation's Mathlib pin-update gate.
