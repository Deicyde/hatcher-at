...
Chapters follow Hatcher's own order. Every formalizable leaf in the selected
§1.1, §1.2, §1.3, §2.1, and Appendix A.1 slices is complete: 119 local
declarations and 14 pinned Mathlib declarations across 133 leaves. The §1.3
spine extends through Proposition 1.40, and the §2.1 spine covers
singular-homology functoriality and homotopy invariance. The remaining source
