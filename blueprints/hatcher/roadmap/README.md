...
formalizable leaves. Of these, 140 are complete: 122 local declarations and 18
...
relative homotopy invariance. Seven of its leaves are complete, including the
simplicial-pair foundation supplied by Mathlib v4.34.1 and the local
singular-pair functor. Eight downstream leaves remain, with relative singular
homology ready next. The remaining source is mapped for navigation and
explicitly deferred so the book reads end to end and later work has somewhere
to land. The
