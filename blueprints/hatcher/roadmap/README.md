...
formalizable leaves. Of these, 147 are complete: 129 local declarations and 18
...
relative homotopy invariance. Fourteen of its leaves are complete, including the
...
homotopy branch through Proposition 2.19 and the reduced pair sequence with its
naturality are complete. One downstream leaf remains: the pointed comparison,
ready to state.
