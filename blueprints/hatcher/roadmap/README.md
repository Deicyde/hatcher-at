...
formalizable leaves. Of these, 142 are complete: 124 local declarations and 18
...
relative homotopy invariance. Nine of its leaves are complete, including the
...
sequence and its connecting-map formula. Six downstream leaves remain; five
are ready to state and one awaits pair-sequence naturality. The remaining
