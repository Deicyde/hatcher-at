...
formalizable leaves. Of these, 141 are complete: 123 local declarations and 18
...
relative homotopy invariance. Eight of its leaves are complete, including the
simplicial-pair foundation supplied by Mathlib v4.34.1 and the local
singular-pair and relative-homology functors. Seven downstream leaves remain;
four statements are now ready to formalize. The remaining source is mapped for
navigation and explicitly deferred so the book reads end to end and later work
has somewhere to land. The
