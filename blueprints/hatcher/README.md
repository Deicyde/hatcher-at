...
contains 152 formalizable leaves. Of these, 148 are complete: 130 local
...
are complete, finishing that selected §2.1 slice. Four additional leaves now
decompose the long exact sequence of a triple and its naturality.
