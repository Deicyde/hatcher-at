...
contains 162 formalizable leaves. The previously selected 152 are complete:
134 are formalized locally and 18 are pinned Mathlib declarations. These
comprise all 133 nodes
...
formalization leaves; none is yet claimed complete. The coverage contract
explicitly defers the other remaining main-line source areas, and decomposition
alone is not a claim of formalization progress.
