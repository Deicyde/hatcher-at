...
contains 148 formalizable leaves, of which 147 are complete: 129 local
...
A.1 slices, plus fourteen nodes in a fifteen-leaf §2.1 reduced- and
...
2.19 and the reduced pair sequence with its naturality are complete. One
downstream node remains: the pointed comparison, ready to state.
