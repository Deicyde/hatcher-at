...
Thirteen of these fifteen leaves are complete. The simplicial-pair foundation is
...
sequence are complete. Two downstream leaves remain incomplete: the pointed
comparison and reduced-pair-sequence naturality, both ready to state.
...
- **Relative theory.** Use the merged `SSetPair` design. Its foundational node
  ...
  pair-sequence naturality, reduced pair sequence, and relative homotopy branch
